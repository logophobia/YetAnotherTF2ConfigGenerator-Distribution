...
* Download the program https://github.com/logophobia/YetAnotherTF2ConfigGenerator-Distribution/archive/master.zip
...
It indicates when the viewmodel is turned off or on:
